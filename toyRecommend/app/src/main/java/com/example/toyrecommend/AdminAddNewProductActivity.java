...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String CategoryName, Description, Price, Pname, Pcode, saveCurrentDate, saveCurrentTime;
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        productMap.put("ratings", 0.0);
      //  productMap.put("sort_or", "null");
